...
#
# 2002-11-22 Jurgen Hermann <jh@web.de>
...
def make_escapes(pass_nonascii):
    ...
    if pass_nonascii:
        ...
        # "Hohe"' would result not result in 'msgid "H\366he"'.  Otherwise we
...
def getFilesForName(name):
    ...
    if os.path.isdir(name):
        ...
        _py_ext = (importlib.machinery.SOURCE_SUFFIXES[0], '.kv')
...
def main():
    ...
    for arg in args:
        if arg == '-':
            ...
            expanded.extend(getFilesForName(os.path.join(os.getcwd(), arg)))
    args = expanded
    print(args)
